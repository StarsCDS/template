...
class KMeansClusterer:
    ...
    def run(self, df: Any, features_scaled: np.ndarray, output_dir: str) -> Dict[str, Any]:
        ...
        Args:
            df: The input dataframe (unused in this method, but kept for consistency).
            features_scaled: Scaled features for clustering.
            output_dir: Directory to save output plots.

        Returns:
            Dict containing scores and optimal number of clusters.
        """
        inertia = []
        silhouette_scores = []
