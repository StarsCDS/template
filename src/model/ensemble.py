...
class EnsembleClusterer:
    ...
    def evaluate_clustering_models(self, X_scaled: np.ndarray) -> pd.DataFrame:
    ...
    def soft_voting_ensemble(self, X_scaled: np.ndarray, n_clusters: int) -> np.ndarray:
    ...
    def majority_voting_ensemble(self, X_scaled: np.ndarray, n_clusters: int) -> np.ndarray:
    ...
    def stacking_ensemble(self, X_scaled: np.ndarray, n_clusters: int, n_init: int = 10) -> np.ndarray:
